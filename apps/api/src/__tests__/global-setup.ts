 ...
 *
 * Loads .env, points the API's pool at DATABASE_URL_TEST, and applies all
 * kernel migrations so the `events` table (and its immutability trigger)
 * exist. Mirrors packages/kernel/src/__tests__/global-setup.ts.
 */
